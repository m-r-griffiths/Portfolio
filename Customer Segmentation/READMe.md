...
- **Data**: 951k+ order rows across 47 countries (2012–2016). Final modelling uses customer-level features: frequency, recency, Customer Lifetime Value (CLV), average unit cost, and age.

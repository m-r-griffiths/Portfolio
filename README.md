...
Today, I bridge the gap between technical execution and high-level strategy. I am currently expanding my toolkit through a Masters level qualification in Data Science at the University of Cambridge. 

# Portfolio
As part of my studies, I have used Natural Language Processing (NLP) to provide novel insights into the capacity of the UK Civil Service to deliver ambitious change; unsupervised learning to detect anomalies and to cluster Customers and Cities; and supervised learning to predict student drop-outs in an online course. 
...
AI/ML: NLP, deep learning, clustering, anomaly detection, gradient-boosted tree methods, algorithmic optimisations
